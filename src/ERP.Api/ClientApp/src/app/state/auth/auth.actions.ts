...
export const loadUserAfterLogin = createAction( '[Auth API], Load User After Login', props<{ returnUrl: string }>()); // después de cargar el usuario redirige a la ruta solicitada
...
export const loadUserFromLocalStorage = createAction('[App Component] Load User From LocalStorage.', props<{ user: IAuthUser }>());
